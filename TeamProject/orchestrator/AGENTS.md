# AGENTS.md - Regles de session (Orchestrator)
...
- Dispatcher des taches aux agents
...
- Surveiller TOUS les builds CI des agents dev
- Si un agent pousse du code casse : la mission est ECHOUEE
- Relancer l'agent fautif avec la regle DoD
- Verifier les livrables dans workspace-shared/ avant de declarer une tache terminee
