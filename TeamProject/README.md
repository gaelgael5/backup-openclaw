...
- **dev-flutter**: 7 fichiers markdown
- **dev-python**: 7 fichiers markdown
- **legal**: 6 fichiers markdown
- **marketer**: 7 fichiers markdown
- **orchestrator**: 7 fichiers markdown
- **product**: 7 fichiers markdown
- **shared**: 7 fichiers markdown
- **strategist**: 6 fichiers markdown
- **sysadmin**: 7 fichiers markdown
- **tester-flutter-qa**: 7 fichiers markdown
- **ux-researcher**: 7 fichiers markdown
